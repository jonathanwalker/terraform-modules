...
resource "aws_lambda_permission" "permission" {
  ...
  source_arn = "arn:aws:execute-api:${data.aws_region.current.name}:${data.aws_caller_identity.account_id}:${aws_api_gateway_rest_api.gateway.id}/*/${aws_api_gateway_method.method.http_method}${aws_api_gateway_resource.resource.path}"
}
